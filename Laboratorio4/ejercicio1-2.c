...
int main() {
    ...
    switch (rf) {
        case -1: // Fallo al ejecutar el fork
            ...
            break;
        case 0: // Proceso hijo
            i = 100; // Asigna una valor a i el cual es 100
        ...
        default: // Proceso padre
            i = 100; // Asigna un valor a i el cual es 100
            // Imprime el id del proceso hijo con la funcion getpid() y el valor de i
            printf("\nSoy el padre, mi PID es %d y mi variable i (inicialmente a %d) es par", getpid( ), i);
            for (j = 0; j < 5; j++) { // Repite 5 veces el bucle
                i++;
                i++;
